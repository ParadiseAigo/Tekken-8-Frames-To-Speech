...
#define TEKKEN_VERSION "2.05.00"

#define P1_RECOVERY_FRAMES_STATIC_POINTER 0x9B38CE8
#define P1_RECOVERY_FRAMES_POINTER_OFFSETS {0x30, 0xE40}

#define P1_STATE_STATIC_POINTER 0x9B38CE8
#define P1_STATE_POINTER_OFFSETS {0x30, 0x548}

#define P2_STATE_STATIC_POINTER 0x9B38CE8
#define P2_STATE_POINTER_OFFSETS {0x38, 0x548}
