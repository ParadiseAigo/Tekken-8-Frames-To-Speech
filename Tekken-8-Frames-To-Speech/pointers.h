...
#define TEKKEN_VERSION "2.08.00"

#define P1_RECOVERY_FRAMES_STATIC_POINTER 0x9B56AE0
#define P1_RECOVERY_FRAMES_POINTER_OFFSETS {0x30, 0xFC0}

#define P1_STATE_STATIC_POINTER 0x9B56AE0
#define P1_STATE_POINTER_OFFSETS {0x30, 0x548}

#define P2_STATE_STATIC_POINTER 0x9B56AE0
