...
#define P1_RECOVERY_FRAMES_STATIC_POINTER 0x99BAFB0
#define P1_RECOVERY_FRAMES_POINTER_OFFSETS {0x30, 0xC98}

#define P1_STATE_STATIC_POINTER 0x99BAFB0
#define P1_STATE_POINTER_OFFSETS {0x30, 0x51C}

#define P2_STATE_STATIC_POINTER 0x99BAFB0
