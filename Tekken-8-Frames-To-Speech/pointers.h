...
#define P1_RECOVERY_FRAMES_STATIC_POINTER 0x94B6328
#define P1_RECOVERY_FRAMES_POINTER_OFFSETS {0x30, 0x1c198}

#define P1_STATE_STATIC_POINTER 0x94B6328
#define P1_STATE_POINTER_OFFSETS {0x30, 0x518}

#define P2_STATE_STATIC_POINTER 0x94B6328
