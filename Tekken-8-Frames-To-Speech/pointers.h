...
#define P1_RECOVERY_FRAMES_STATIC_POINTER 0x9B15B38
#define P1_RECOVERY_FRAMES_POINTER_OFFSETS {0x30, 0xD2C}

#define P1_STATE_STATIC_POINTER 0x9B15B38
#define P1_STATE_POINTER_OFFSETS {0x30, 0x528}

#define P2_STATE_STATIC_POINTER 0x9B15B38
