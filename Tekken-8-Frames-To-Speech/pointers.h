...
#define P1_RECOVERY_FRAMES_STATIC_POINTER 0x9A69650
#define P1_RECOVERY_FRAMES_POINTER_OFFSETS {0x30, 0xCB8}

#define P1_STATE_STATIC_POINTER 0x9A69650
#define P1_STATE_POINTER_OFFSETS {0x30, 0x51C}

#define P2_STATE_STATIC_POINTER 0x9A69650
